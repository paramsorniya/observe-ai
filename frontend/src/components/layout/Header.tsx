    ...
    <header className="sticky top-0 z-20 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex items-center gap-4 h-16 px-4">
        ...
        <div className="relative" ref={projectRef}>
          ...
          {projectDropdownOpen && (
            <div className="absolute left-0 top-full mt-1 w-64 rounded-md border bg-popover p-1 shadow-md z-50">
      ...
      {isSharedProject && (
        <div className="flex items-center gap-2 px-4 py-1.5 bg-blue-50 dark:bg-blue-950/40 border-t border-blue-100 dark:border-blue-900 text-xs text-blue-700 dark:text-blue-300">
          <Users className="h-3.5 w-3.5 shrink-0" />
          <span>
            You're viewing a shared project —{' '}
            <strong>{currentProject?.name}</strong>. Your subscription, settings, and own projects
            are separate from this collaboration.
          </span>
        </div>
      )}
    </header>
